...
function checkWinConditions() {
    console.log("hello from check win conditions");
    // X 0,1,2 condition.
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //returned annd our else if condition executes the drawWinLine function.
...
function audio(audioURL) {
    //We create a  neew audio object annd we pass the path as parameter.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    x2 = coordX2,
    //This line indicates where the end of a lines y asix is.
    y2 = coordY2,
    //This variable stores temporarry x axis data we update in our animation loop.
    x = x1, 
    //This variable stores temporary y axis data we update in our animation loop.
    y = y1;

    //This functionn interacts with the canvas
    function animateLineDrawing() {
        ...
        c.stroke();
        //This condition checks if we've reached the endpoinnt.
        if(x1 <= x2 && y1 <= y2) {
            //This condition adds 10 to the previous end x point.
            if(x < x2) { x += 10; }
            //Tthis condition adds 10 to the previous end y point.
            if (y < y2) { y += 10; }
    ...
    //This function clears our canvas afterr our win line is drawn.
    function clear() {
        //This line starts our animationn loop.
        const animationLoop = requestAnimationFrame(clear);
        //This line clears our canvas.
        c.clearRect(0,0,608,608);
        //This line stops our animationn loop.
...
function resetGame() {
    //This for loop iterattes through each HTML square element.
    for(let i=0; i<9; i++) {
